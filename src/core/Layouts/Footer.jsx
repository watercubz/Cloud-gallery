        ...
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/watercubz/MTAAI-core"
                    target="_blank"
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                  <a
                    href="mailto:eurysosagarcia@gmal.com"
                    target="_blank"
                    className="hover:underline"
                  >
                    Contact Us
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/watercubz/MTAAI-core/blob/master/LICENSE.md"
                    target="_blank"
                    className="hover:underline"
                  >
                    Licensing
          ...
          <div className="px-4 py-6 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-500 sm:text-center">
              © 2024{' '}
              <a href="https://github.com/watercubz/MTAAI-core">MTAAI-core™</a>
              . All Rights Reserved.
            </span>
